...
<div class="interactive-viz" markdown="0">
  <iframe src="https://the-principles-of-diffusion-models.github.io/assets/noise_schedule_explorer.html" width="100%" height="820" loading="lazy" style="border:1px solid #ddd;border-radius:8px;" title="Noise Schedule Explorer"></iframe>
...
<div class="interactive-viz" markdown="0">
  <iframe src="https://the-principles-of-diffusion-models.github.io/assets/ddpm_conditional_trick.html" width="100%" height="580" loading="lazy" style="border:1px solid #ddd;border-radius:8px;" title="DDPM Conditional Trick"></iframe>
...
> Maximizing the ELBO of the diffusion hierarchy decomposes into per-step KL terms $$L_{t-1} = D_{\mathrm{KL}}\big(q(\boldsymbol{x}_{t-1}\mid\boldsymbol{x}_t,\boldsymbol{x}_0)\,\|\,p_\theta(\boldsymbol{x}_{t-1}\mid\boldsymbol{x}_t)\big)$$ that reduce to weighted squared errors.
{:.lead}
...
> DDPM drops the per-step weight and trains the **simple noise-prediction loss** $$L_{\text{simple}} = \mathbb{E}_{t,\boldsymbol{x}_0,\boldsymbol{\epsilon}}\big[\,\|\boldsymbol{\epsilon} - \boldsymbol{\epsilon}_\theta(\boldsymbol{x}_t,t)\|^2\big].$$
{:.lead}
...
<div class="interactive-viz" markdown="0">
  <iframe src="https://the-principles-of-diffusion-models.github.io/assets/cov_2d_map.html" width="100%" height="640" loading="lazy" style="border:1px solid #ddd;border-radius:8px;" title="Change-of-Variable 2D Map"></iframe>
